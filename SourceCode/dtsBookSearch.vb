...
Public Class dtsBookSearch
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dtsBookSearch = CType(MyBase.Clone,dtsBookSearch)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dtsBookSearch"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dtsBookSearch.xsd"
