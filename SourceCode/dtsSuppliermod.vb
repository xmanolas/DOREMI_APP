...
Public Class dtsSuppliermod
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dtsSuppliermod = CType(MyBase.Clone,dtsSuppliermod)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dtsSuppliermod"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dtsSuppliermod.xsd"
