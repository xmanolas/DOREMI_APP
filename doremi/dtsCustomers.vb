...
Public Class dtsCustomers
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As dtsCustomers = CType(MyBase.Clone,dtsCustomers)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "dtsCustomers"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/dtsCustomers.xsd"
